...
import { FolderOpen, PackagePlus } from 'lucide-vue-next'

const router = useRouter()

const tools = [
  { name: 'File Manager', icon: FolderOpen, route: { name: 'tools-files' } },
  { name: 'APK Installer', icon: PackagePlus, route: { name: 'tools-apk' } },
]
</script>
